    ...
    public class ExplosiveArrow : ModProjectile
    {
        ...
        private void Explode()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                Dust d = Dust.NewDustPerfect(Projectile.Center, DustID.Smoke, speed * 3, Scale: 1.5f);
                d.noGravity = true;
            }
            ...
            {
                Vector2 speed = Main.rand.NextVector2CircularEdge(1f, 1f);
                Dust d = Dust.NewDustPerfect(Projectile.Center, DustID.Torch, speed * 2, Scale: 1.2f);
                d.noGravity = true;
            }
